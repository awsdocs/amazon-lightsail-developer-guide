...
![\[Activate the WP Offload Media Lite plugin for WordPress.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wp-offload-media-plugin-activate.png)
...
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-storage-provider.png)

1. Choose **My server is on Amazon Web Services and I'd like to use IAM Roles**\.  
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-access-setting.png)

1. Choose **Next**\.  
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-next.png)

1. Choose **Browse existing buckets** in the **What bucket would you like to use?** page that appears\.  
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-browse-existing-buckets.png)

1. Choose the name of the bucket that you want to use with your WordPress instance\.  
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-existing-buckets.png)
...
![\[WP Offload Media page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-offload-media-settings.png)
...
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media.png)

1. Choose **Select Files** on the Upload New Media page that appears\.  
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media-upload.png)

1. Choose a media file to upload from your local computer, and choose **Open**\.  
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media-open.png)

1. When the file is done uploading, choose **Library** under **Media** in the left navigation menu\.  
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media-library-menu.png)

1. Choose the file that you recently uploaded\.  
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media-library.png)

1. In the details panel of the file, you should see the name of your bucket in the **Bucket** and **File URL** fields\.  
![\[\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-wordpress-dashboard-new-media-details.png)
...
![\[The wp content folder in a bucket\]](https://d9yljz1nd5001.cloudfront.net/en_us/cdafd3c2a6d9edfefee89eda217b0068/images/amazon-lightsail-bucket-objects-wp-content-folder.png)
