...
1. After your Lightsail browser\-based SSH session is connected, enter the following command to update the packages on your instance:
   ...
   sudo apt-get update
   ```  
![\[Update the packages on your instance.\]](https://d9yljz1nd5001.cloudfront.net/en_us/a7664053563006144d6133a21b463972/images/amazon-lightsail-wordpress-ssh-lets-encrypt-update-packages.png)
...
![\[Add a new plugin in WordPress.\]](https://d9yljz1nd5001.cloudfront.net/en_us/a7664053563006144d6133a21b463972/images/amazon-lightsail-wordpress-add-new-plugin.png)

1. Search for **Really Simple SSL**\.

1. Choose **Install Now** next to the Really Simple SSL plugin in the search results\.  
![\[The Really Simple SSL plugin for WordPress.\]](https://d9yljz1nd5001.cloudfront.net/en_us/a7664053563006144d6133a21b463972/images/amazon-lightsail-wordpress-really-simple-ssl-plugin.png)
