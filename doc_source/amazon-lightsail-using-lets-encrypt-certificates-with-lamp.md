...
![\[SSH quick connect on the Lightsail home page.\]](https://d9yljz1nd5001.cloudfront.net/en_us/1cade0c7e07039bf59652df47a09d228/images/amazon-lightsail-lamp-ssh-quick-connect.png)
...
1. After your Lightsail browser\-based SSH session is connected, enter the following command to update the packages on your instance:
   ...
   sudo apt-get update
   ```  
![\[Update the packages on your instance.\]](https://d9yljz1nd5001.cloudfront.net/en_us/1cade0c7e07039bf59652df47a09d228/images/amazon-lightsail-lamp-ssh-lets-encrypt-update-packages.png)
...
## Step 7: Configure a cron job that renews your certificate<a name="configure-a-cron-job-that-renews-certs-lamp"></a>
...
**To integrate your Let’s Encrypt certificate with your LAMP instance**
...
![\[Apache configuration file edited for HTTP to HTTPs redirection.\]](https://d9yljz1nd5001.cloudfront.net/en_us/1cade0c7e07039bf59652df47a09d228/images/amazon-lightsail-lamp-ssh-lets-encrypt-apache-config-file.png)
