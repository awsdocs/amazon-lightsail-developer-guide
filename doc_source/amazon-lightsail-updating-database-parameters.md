...
![\[Get relational database parameters result\]](https://d9yljz1nd5001.cloudfront.net/en_us/a7664053563006144d6133a21b463972/images/amazon-lightsail-get-database-parameters-result.png)
**Note**  
...
+ Enter the following command into a terminal or command prompt window to update a parameter for your managed database\.
  ...
  You should see a result similar to the following example:  
![\[Change relational database parameters result\]](https://d9yljz1nd5001.cloudfront.net/en_us/a7664053563006144d6133a21b463972/images/amazon-lightsail-update-database-parameters-result.png)
