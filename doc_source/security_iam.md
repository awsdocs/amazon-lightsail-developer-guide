# Identity and Access Management for Amazon Lightsail<a name="security_iam"></a>

 *Last updated: February 18, 2020* 

## Audience<a name="security_iam_audience"></a>

How you use AWS Identity and Access Management \(IAM\) differs, depending on the work you do in Lightsail\.

**Service user** – If you use the Lightsail service to do your job, then your administrator provides you with the credentials and permissions that you need\. As you use more Lightsail features to do your work, you might need additional permissions\. Understanding how access is managed can help you request the right permissions from your administrator\. If you cannot access a feature in Lightsail, see [Troubleshooting Amazon Lightsail Identity and Access](security_iam_troubleshoot.md)\.

**Service administrator** – If you're in charge of Lightsail resources at your company, you probably have full access to Lightsail\. It's your job to determine which Lightsail features and resources your employees should access\. You must then submit requests to your IAM administrator to change the permissions of your service users\. Review the information on this page to understand the basic concepts of IAM\. To learn more about how your company can use IAM with Lightsail, see [How Amazon Lightsail Works with IAM](security_iam_service-with-iam.md)\.

**IAM administrator** – If you're an IAM administrator, you might want to learn details about how you can write policies to manage access to Lightsail\. To view example Lightsail identity\-based policies that you can use in IAM, see [Amazon Lightsail Identity\-Based Policy Examples](security_iam_id-based-policy-examples.md)\.
...
## Additional information<a name="security-additional-information"></a>
